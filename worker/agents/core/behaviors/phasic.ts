...
import { AllIssues, AgentInitArgs, BehaviorType, PhaseExecutionResult, UserContext } from '../types';
...
export class PhasicCodingBehavior extends BaseCodingBehavior<PhasicState> implements ICodingAgent {
    ...
    // Override to always return 'phasic' - fixes race condition where state isn't initialized yet
